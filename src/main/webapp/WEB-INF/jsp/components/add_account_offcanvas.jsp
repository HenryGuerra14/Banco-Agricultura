...
<!-- Right Side Offcanvas: Accounts Form Container -->
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel" class="text-white">Crear / Agregar una cuenta </h5>
                ...
                <div class="card-body">
                    <form action="/account/create_account"  method="POST" class="add-account-form">
                        ...
                        <div class="form-group mb-3">
                            <label for=""> Ingresa nombre de la cuenta</label>
                            <input type="text" name="account_name" class="form-control" placeholder="Ingresa nombre de la cuenta...">
                        </div>
                        <!-- End Of Form Group -->
                        <!-- Form Group -->
                        <div class="form-group mb-3">
                            <label for=""> Selecciona tipo de cuenta</label>
                        ...
                        <div class="form-group my-2">
                            <button id="" class="btn btn-md transact-btn">Agregar cuenta</button>
                        </div>
                        <!-- End Of Form Group -->
