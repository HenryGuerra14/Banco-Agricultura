...
<!-- Container -->
    <div class="container d-flex">
        ...
        <button id="add-account-btn" class="btn btn-lg shadow" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
           <i class="fa fa-credit-card"></i> Agregar nueva cuenta
        </button>
        ...
        <button id="transact-btn" class="btn btn-lg ms-auto shadow" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
           <i class="fa fa-wallet"></i> Transaccion
        </button>
    ...
    <div class="container d-flex py-3">
        ...
        <h2 class="ms-auto" style="color: white">
              ...
              <div id="flush-${account.account_id}" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex">Nombre de cuenta <span class="ms-auto"><b>${account.account_name}</b></span></li>
                        <li class="list-group-item d-flex">Numero de cuenta <span class="ms-auto"><b>${account.account_number}</b></span></li>
                        <li class="list-group-item d-flex">Tipo de cuenta <span class="ms-auto"><b>${account.account_type}</b></span></li>
                        <li class="list-group-item d-flex">Balance de cuenta <span class="ms-auto"><b>${account.balance}</b></span></li>
                        <li class="list-group-item d-flex">Fecha <span class="ms-auto"><b>${account.created_at}</b></span></li>
                    </ul>
                    <!-- Account Details List -->
                </div>
              </div>
