...
<body class="d-flex align-items-center">
    ...
    <div id="sample-text-card" class="card col-6 bg-transparent border-0">
        ...
        <div class="card-body">
            <!-- Card Header -->
           <h1 class="mb-3">Banco de Agricultura</h1>
           <!-- End Card Header -->
           ...
           <div class="button-wrapper d-flex align-items-center">
                <a href="/register" class="btn btn-md register" role="button">Registrarme</a>
                <a href="/login" class="btn btn-md login" role="button">Conectarme</a>
           </div>
